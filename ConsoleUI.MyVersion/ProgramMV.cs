...
{
    ProductService productManager = new ProductService(products);

    PrintSeparator("Ürün ekle ve listele: ");
    Product createdProduct = productManager.GetProductInput(products);
    ...
    void PurchaseOfProduct()
    {
        ...
        Product updatedProduct = new Product(
            product.Id, product.Name, product.Price, newStock
            );
        ...
        Console.WriteLine($"Thw amount bought : {stock}");
